...
int main(int argc,char* argv[]) {
  ...
  if (easyMode == 1) {
    //easymode numbers
    int easyNumbers[] = {3,9,4,1,8,5,8,1,6,1,5,1,2,8,7,8,5,2,9,2,2,6,8,4,5,5,4,3,6,6,2,6,8,4,2,6,6,2,8,1};
  ...
  double answer1 = getValue((double)(j), (double)(k), input1[0]);
  //if statements to check if the double variable needs to be turned into an integer.
  //if the double number ends in only zeros, then it will be converted into an integer.
  //otherwise it will stay as a double. 
  // if (!(fabs((double)(answer1) - (int)(answer1)) < 0.001) && input1[0] == '/') {
  //   printf("%d %c %d = %f.\n",j,input1[0],k,(answer1));
  // } else {
  //   printf("%d %c %d = %d.\n",j,input1[0],k,(int)(answer1));
  // }
  printf("%d %c %d = %d.\n",j,input1[0],k,(int)(answer1));
    //same with the second calculation
  double answer2 = getValue(answer1, (double)(l), input1[1]);
  // if (!(fabs((double)(answer2) - (int)(answer2)) < 0.001)) {
  //   if (!(fabs((double)(answer1) - (int)(answer1)) < 0.001)) {
  //     printf("%f %c %d = %f.\n",(answer1),input1[1],l,(answer2));
  //   } else {
  //     printf("%d %c %d = %f.\n",(int)(answer1),input1[1],l,(answer2));
  //   }
  // } else {
  //   if (!(fabs((double)(answer1) - (int)(answer1)) < 0.001)) {
  //     printf("%f %c %d = %.d\n",(double)(answer1),input1[1],l,(int)(answer2));
  //   } else {
  ...
  double answer3 = getValue(answer2, (double)(m), input1[2]);
  // if (!(fabs((double)(answer3) - (int)(answer3)) < 0.001)) {
  //   if (!(fabs((double)(answer2) - (int)(answer2)) < 0.001)) {
  //     printf("%f %c %d = %f.\n",(double)(answer2),input1[2],m,(answer3));
  //   } else {
  //     printf("%d %c %d = %f.\n",(int)(answer2),input1[2],m,(answer3));
  //   }
    
  // } else {
  //   if (!(fabs((double)(answer2) - (int)(answer2)) < 0.001)) {
  //     printf("%f %c %d = %d.\n",(double)(answer2),input1[2],m,(int)(answer3));
  //   } else {
